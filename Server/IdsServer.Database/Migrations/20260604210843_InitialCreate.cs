        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RawBasket = table.Column<string>(type: "nvarchar(max)", maxLength: 50000, nullable: false),
                    HookUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ArticleNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    NetPrice = table.Column<decimal>(type: "decimal(2,2)", precision: 2, nullable: false),
                    OfferPrice = table.Column<decimal>(type: "decimal(2,2)", precision: 2, nullable: false),
